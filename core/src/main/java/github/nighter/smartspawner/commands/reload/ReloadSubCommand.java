...
public class ReloadSubCommand extends BaseSubCommand {
    ...
    private void reloadAll(CommandSender sender) {
        try {
            ...
            plugin.reloadConfig();
            if (plugin.getEmpConfig() != null) {
                plugin.getEmpConfig().reload();
            }
            ...
            if (plugin.getGemEventService() != null) {
                plugin.getGemEventService().reload();
            }
            if (plugin.getGemRewardService() != null) {
                plugin.getGemRewardService().stop();
                plugin.getGemRewardService().start();
            }
